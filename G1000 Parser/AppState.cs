...
namespace Glass_Cockpit
{
    public class AppState
    {
        ...
        internal async Task loadState()
        {
            ...
            {
                var frame = new Frame();
                if (needsLoadFolder) frame.Navigate(typeof(Setup.ImportLocationPage), this);
                if (needsArchiveFolder) frame.Navigate(typeof(Setup.ArchiveLocationPage), this);
                if (needsSaveFile) frame.Navigate(typeof(Setup.ExportLocationPage), this);
        ...
        internal async Task loadFolder()
        {
            ...
            else this.errors.Add(new Error(null, "No load folder", "No load folder is selected."));
        }
